...
val CustomColor1 = Color(0xFFC8BBFF)
val light_CustomColor1 = Color(0xFF6151A6)
val light_onCustomColor1 = Color(0xFFFFFFFF)
val light_CustomColor1Container = Color(0xFFE6DEFF)
val light_onCustomColor1Container = Color(0xFF1D0160)
val dark_CustomColor1 = Color(0xFFCBBEFF)
val dark_onCustomColor1 = Color(0xFF322075)
val dark_CustomColor1Container = Color(0xFF49398C)
val dark_onCustomColor1Container = Color(0xFFE6DEFF)

fun colorWithAlpha(color:Color, alpha:Float):Color{

    return Color(red = color.red, green = color.green, blue = color.green, alpha = alpha)
}